...
def run_vram_audit(args) -> int:
    from vram_audit import run as vram_audit_run
    return vram_audit_run(args.models_dir, args.data_dir)
...
def main() -> int:
    ...
    elif args.command == "vram-audit": return run_vram_audit(args)
