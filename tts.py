...
VARIANTS = {
    "nano": Variant(
        ...
        pid_name="server.pid", build_name="gpt2", ckpt_name=".ckpt",
    ...
    "turbo": Variant(
        ...
        pid_name="turbo.pid", build_name="gpt2", ckpt_name=".ckpt",
    ...
    "v3": Variant(
        ...
        pid_name="v3.pid", build_name="v3", ckpt_name=".ckpt-v3", other_pids=(),
