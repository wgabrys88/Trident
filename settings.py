...
PROMPTS = {
    "speak": {
        ...
        "llama": "Each line is language|text. language is from: {languages}. Each text is one spoken chunk: a complete thought, two or three sentences, about {limit} characters, one language. Split only where meaning pauses or the language changes. Never mid-sentence. Never by counting letters. Never mix languages on one line. Keep the original words. Do not translate. Keep source order. Many lines. Keep every fact. Do not summarize. Do not copy example wording. Format only: en|Hello from Trident. pl|Dzien dobry tu Trident. No markdown.",
    },
